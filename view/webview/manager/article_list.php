...
<nav aria-label="Page navigation example" style="position: absolute;bottom: 10px;left: 42%">
    ...
    <ul class="pagination justify-content-center" >
                ...
                <a class="page-link" href="<?php if($page==1) echo "index.php?page=1"; else echo "article_list.php?page=".($page-1); ?>">&laquo;</a>
                </li>
   <?php
          for ($i=1;$i<=$totalPage;$i++) { 
     ?>
           <li class="page-item <?php if($page==$i) echo "active";?>"><a class="page-link"href="article_list.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
        <?php
  }
?>
                <li class="page-item <?php if($page==$totalPage) echo "disabled";?>"><a class="page-link" href="<?php if($page==$totalPage) echo "article_list.php?page=".$totalPage; else echo "article_list.php?page=".($page+1); ?>">&raquo;</a></li>
            </ul>
</nav>
