...
<table class="table table-sm">
    ...
    <tbody>
    <?php
$articles=$conn->query("select * from user order by id DESC limit $startCount,$perNumber");  
...
<nav aria-label="Page navigation example" style="position: absolute;bottom: 10px;left: 42%">
    ...
    <ul class="pagination justify-content-center" >
                ...
                <a class="page-link" href="<?php if($page==1) echo "index.php?page=1"; else echo "user_info.php?page=".($page-1); ?>">&laquo;</a>
                </li>
   <?php
          for ($i=1;$i<=$totalPage;$i++) { 
     ?>
           <li class="page-item <?php if($page==$i) echo "active";?>"><a class="page-link"href="user_info.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
        <?php
  }
?>
                <li class="page-item <?php if($page==$totalPage) echo "disabled";?>"><a class="page-link" href="<?php if($page==$totalPage) echo "user_info.php?page=".$totalPage; else echo "user_info.php?page=".($page+1); ?>">&raquo;</a></li>
            </ul>
</nav>
...
<script>
    ...
    function ifdelete(id,username) {
        ...
        var url="douserdel.php?id="+id+"&username="+username;
